...
Locations = [location("Cylinder", -1.45, -3.96,0.672,0.740),location("Dumpster",2.63,-4.28,0.89,0.455),location("Bookshelf",1.633,2.41,0.926,-0.378),location("Barrier",-4.57,-1,0.11,0.99)]

#Locatio

ns = [location("Kitchen", 0.59, -2.05,0.969, -0.247),location("TV",2.06,3.84,0.908,-0.42),location("Desk",-0.22,0.198,-0.0345,1),location("Dinning",-3.8,0.2715,0,1)]
